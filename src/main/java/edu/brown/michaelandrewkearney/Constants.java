...
public class Constants {
    ...
    public static final Font DIN_BLACK = Font.loadFont(Constants.class.getClassLoader().getResourceAsStream("fonts/DINPRO-BLACK.OTF"), 12);
    public static final Font DIN_BOLD = Font.loadFont(Constants.class.getClassLoader().getResourceAsStream("fonts/DINPRO-BOLD.OTF"), 12);
    public static final Font DIN_MEDIUM = Font.loadFont(Constants.class.getClassLoader().getResourceAsStream("fonts/DINPRO-MEDIUM.OTF"), 12);
    public static final Font DIN_REGULAR = Font.loadFont(Constants.class.getClassLoader().getResourceAsStream("fonts/DINPRO-REGULAR.OTF"), 12);
    public static final Font DIN_LIGHT = Font.loadFont(Constants.class.getClassLoader().getResourceAsStream("fonts/DINPRO-LIGHT.OTF"), 12);
