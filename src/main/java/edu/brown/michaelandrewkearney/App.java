 ...
 * which avoids having to deal with a date. This allows the application to wrap around at the end of each day, so if you
 * wait through the night, trains will start up again at 4:42 AM. (Note: per Indian custom, 24-hour time is used).
 *
...
public class App extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.getIcons().addAll(new Image(App.class.getClassLoader().getResourceAsStream("icons/logo16.png")),
                new Image(App.class.getClassLoader().getResourceAsStream("icons/logo20.png")),
                new Image(App.class.getClassLoader().getResourceAsStream("icons/logo32.png")));
